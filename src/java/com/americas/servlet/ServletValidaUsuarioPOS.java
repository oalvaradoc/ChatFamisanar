 ...
 * @author omaalvca
 */
public class ServletValidaUsuarioPOS extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            {
                response.sendRedirect("http://200.122.252.187:8085/ChatFamisanar/ServletCargaListaPOS");
                return;
            }
            else
            {
        ...
        catch(IOException | ServletException ex)
        {
            ...
            Error.Page_Error(ex.toString(),"doPost","Validacion de Usuario POS",ex);
        }  
    }
