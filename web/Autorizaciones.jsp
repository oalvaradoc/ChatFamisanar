    ...
    <body style="" onload="Validar()">
        ...
        <div class="container mt15">
            ...
            <form  data-ajax="true"  data-ajax-loading="#progress" 
                   id="form0" method="post" class="" action="ServletValidaUsuarioAUTO">    
                <div id="contenInfo">
                    <div class="row" id="logimg">
                        <div class="center-align">
                            <img class="responsive-img" id="logosala" src="img/Sala_AUTO.jpg">
                        </div>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </div>
                    <div class="" style="margin-top:1.5% !important;" id="contentForm">
                        <div class="col s12 l6 offset-l3">
                            ...
                            <h6> Señor usuario le informamos que nuestro horario de atención <strong>para el chat 
                                    de Autorizaciones </strong> es de lunes a viernes de 7:00 am a 5:30 pm. jornada continua.</h6>
                            </p>
                            <p>
                                <strong>
            ...
            <form action="ServletIngresaUsuarioAUTO" data-ajax="true" id="form1" method="post" style="display:none" >    
                ...
                <div id="Dv_CompleteForm" name ="Dv_CompleteForm">
                    <div class="row" style="width:10px;position: absolute;">
                        <div class="input-field col s12 m6 l6">
                            <select class=" select-dropdown hide" id="ddl_requerimiento" name="ddl_requerimiento" 
                                    size="5" data-tooltip="Por favor ingrese el requerimiento" 
                        ...
                        <div class="input-field col s12 m6 l6">
                            <input id="nombreUsuario" onkeypress="" name="nombreUsuario" 
                                   ...
                                   data-delay="50" data-tooltip="Por favor ingrese nombre" 
                    ...
                    <div class="row">
                        <div class="input-field col s12 m6 l6">
                            <input id="numContacto" type="text" class="validate tooltipped" 
                                   name="numContacto"
                                   onkeypress="this.value = this.value.toLowerCase();" 
                                   required="" aria-required="true" 
                                   data-position="bottom" data-delay="50" placeholder="Número de Contacto"
                                   data-tooltip="Por favor ingrese el número de contacto" 
                                   value="<fmt:out value="${cli_NumContacto}" />"
                                   >
                    ...
                    <div class="row center-align">            
                        <div class="input-field col s12 m12 l12" id="div-container-envioInfoCorreo">
                            <input type="checkbox" id="cb_habeasEnvioCorreo" name="cb_habeasEnvioCorreo" onclick="return Aceptacion();">
        ...
        <script type="text/javascript">
                        ...
                        function Validar()
                        {
                            ...
                            if (validador == "Mostrar")
                            {
                                ...
                                swal("PRECONDICIONES",
                                "Señor usuario por favor tener escaneados los siguientes documentos: \n \n -Orden medica \n-Copia de Historia Clinica (opcional) \n-Formato de solicitud de servicios no incluidos en el Plan de Beneficios (opcional) \n \n El archivo adjunto podrá ser manejado en los siguientes formatos: .TIFF, .TIF, .JPEG, .JPG, .PNG, .PDF con un tamaño de 1 MB.");
                            }
                        }
                        ...
                        function Mensaje()
                        {
                            ...
                            else
                            {
                                if (horaactual > tiempoSalaHoraInicio)
                                {
                                    ...
                                    if(horaactual == tiempoSalaHoraFin)
                                    {
                                        if (minutoactual >= tiempoSalaMinutoFin ) 
                                        {
                                            MensajeAlerta();
                                        }
                                    }
                        ...
                        function MensajeAlerta()
                        {
                            swal
                                    (
                                            "¡Atención!",
                                            "Estimado usuario, en este momento no es posible atender su solicitud. Recuerde que nuestro horario de atención es lunes a viernes de 7:00 a.m. a 5:30 p.m. jornada continua.",
                                            "info"
                                            ).then((value) => {
                                location.href = "http://www.famisanar.com.co/";
                            });
